...
\section*{Technology Summary}
   \begin{itemize}
   \item{Agile Methodologies (e.g., SCRUM), Version Control (e.g., Git); ANSI-C, C++, Java, Building Tools (e.g. cmake), \LaTeX, Continuous Integration (e.g., Travis CI), MATLAB, Simulink, Python, Embedded Systems, UML, Java/Android, IDE (e.g., Eclipse) Unix, Linux, Mac OS X, Windows.}
   \end{itemize}
