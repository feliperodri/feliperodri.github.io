...
\begin{minipage}{0.45\linewidth}
  \begin{tabular}{ll}
    Phone: & +1 (646) 420-2037 \\
    Email: & {\tt rms.felipe@gmail.com} \\
...
Felipe R. Monteiro is a Senior Applied Scientist with the Automated Reasoning Group at Amazon Web Services. His research combines automated reasoning and neuro-symbolic AI to improve LLM-agent reliability, with soundness as the north star. His background is in software verification of C, C++, and Rust.
...
\section*{Professional Experience}
    ...
    \begin{enumerate}
      \item{{\bf Senior Applied Scientist} at Amazon Web Services, 06/2026 -- {\it present}}
      \begin{itemize}
        \item{\textendash} {Research combining automated reasoning and neuro-symbolic AI to improve LLM-agent reliability;}
        \item{\textendash} \href{https://aws.amazon.com/security/provable-security/}{Automated Reasoning Group}
      \end{itemize}
      \item{{\bf Applied Scientist II} at Amazon Web Services, 10/2021 -- 06/2026}
      \begin{itemize}
        ...
        \item{\textendash} {Combine automated reasoning tools with LLMs to produce formally verified programs;}
        \item{\textendash} \href{https://aws.amazon.com/security/provable-security/}{Automated Reasoning Group}
      \end{itemize}
...
{\bf 21 revised publications and h-index 13}. Full list available at \href{https://scholar.google.com/citations?hl=en&user=6bNQcz0AAAAJ}{Google Scholar} and \href{https://dblp.uni-trier.de/pers/hd/m/Monteiro:Felipe_R=}{DBLP}.
